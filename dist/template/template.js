...
const generateRegistrationConfirmationEmail = (firstName, lastName, isMember, bedOption, paymentReference, paymentStatus, paymentAmount, paymentCurrency, email, phoneNumber, registrationNumber) => {
