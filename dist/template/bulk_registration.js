...
const generateRegistrationConfirmationEmail = (organizerName, participants, paymentReference, paymentStatus, paymentAmount, paymentCurrency) => {
    const participantCards = participants
        .map((participant, index) => {
        const membershipStatus = participant.is_member ? "Member" : "Non-member";
        const registrationOption = participant.bed_option === "registration_with_bed"
...
exports.default = generateRegistrationConfirmationEmail;
